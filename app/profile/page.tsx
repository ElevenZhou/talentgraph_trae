...
import { User, FileText, Calendar, Eye, RefreshCw, Trash2, ArrowRight, AlertCircle, Loader2 } from 'lucide-react'
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-slate-200">
                              {talentData?.identity?.name || `简历-${new Date(record.created_at).toLocaleString('zh-CN', { month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' }).replace(/\//g, '-').replace(/:/g, '-')}`}
                            </h4>
